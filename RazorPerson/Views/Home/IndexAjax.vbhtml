vbhtml<h2 class="text-primary">Liste des personnes (AJAX)</h2>
...
<!-- Zone d'alertes -->
<div id="zoneAlertes" style="margin-top:10px"></div>
...
@Section scripts
    <script>
        ...
        // Fonction affichage alerte
        function afficherAlerte(message, type) {
            var alerte = $("<div class='alert alert-" + type + " alert-dismissible'>" +
                "<button type='button' class='close' data-dismiss='alert'>&times;</button>" +
                message +
                "</div>");
            $("#zoneAlertes").html(alerte);
            setTimeout(function () {
                alerte.fadeOut(500, function () { $(this).remove(); });
            }, 3000);
        }
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.success) {
                        ...
                        $("#btnCharger").click();
                        afficherAlerte(nom + " a été supprimé.", "danger");
                    }
                }
            });
        });
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.success) {
                        ...
                        $("#btnCharger").click();
                        afficherAlerte("Personne modifiée avec succès.", "warning");
                    }
                }
            });
        });
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.success) {
                        ...
                        $("#btnCharger").click();
                        afficherAlerte("Personne ajoutée avec succès.", "success");
                    }
                }
            });
        });
